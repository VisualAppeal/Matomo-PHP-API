...
class Piwik
{
     ...
     * @param string $columns
     * @param bool   $showMetricTitle
     * @param int    $width
     * @param int    $height
     * @param int    $fontSize
     * @param bool   $aliasedGraph    "by default, Graphs are "smooth" (anti-aliased). If you are
    ...
    public function getImageGraph($apiModule, $apiAction, $graphType = '', $outputType = '0',
        ...
        $legendFontSize = '', $aliasedGraph = '1', $idGoal = '', $colors = [], $optional = [])
    {
     ...
     *
     * @param string $segment
     * @param bool   $hideFutureHoursWhenToday Hide the future hours when the report is created for today
     * @param array  $optional
     */
